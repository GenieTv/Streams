...
def INDEX():
    ...
    addDir('[COLORgreen]GenieTv Streams[/COLOR]',BASEURL,111,ART+'streams.png',FANART,'')
...
def CATEGORIES():
        addDir('LIVE TV',BASE,444,ART+'livetv.png',FANART,'')
        addDir('VIDEO ON DEMAND',BASE,555,ART+'vod.png',FANART,'')
        
def LIVECATS():
        addDir4('ENTERTAINMENT',BASE+'entertainment'+CAT,333,ART+'ent.png')
        addDir4('MOVIES',BASE+'movies'+CAT,333,ART+'movies.png')
        addDir4('SPORTS',BASE+'sports'+CAT,333,ART+'sports.png')
        addDir4('KIDS',BASE+'kids'+CAT,333,ART+'kids.png')
        addDir4('DOCUMENTARIES',BASE+'documentaries'+CAT,333,ART+'docu.png')
        addDir4('NEWS',BASE+'news'+CAT,333,ART+'news.png')
        addDir4('MUSIC CHANNELS',BASE+'music'+CAT,333,ART+'music.png')
        addDir4('XXX',BASE+'xxx'+CAT,333,ART+'xxx.png')
        addDir4('USA LIVE TV',BASE+'usatv'+CAT,333,ART+'usa.png')
        addDir4('LIVE EVENTS',BASE+'liveevents'+CAT,333,ART+'live.png')
        
def VODCATS():
        addDir3('MOVIES',BASE4+'mov'+CAT,333,ART+'MOVIESv.png')
        addDir3('POPULAR',BASE,777,ART+'POPULARv.png')
        addDir3('TV SHOWS',BASE,999,ART+'TVSHOWSv.png')
        addDir3('KIDS',BASE,666,ART+'KIDSv.png')
        addDir3('COMEDY',BASE,1000,ART+'COMEDYv.png')
      
def KIDSVOD():
        addDir3('BING',BASE2+'bing'+CAT,333,'http://goo.gl/IHk8Ya')
        addDir3('PEPPA PIG',BASE2+'peppa'+CAT,333,'http://goo.gl/p9pakK')
		
def POPVOD():
        addDir3('ARROW SEASON 1',BASE3+'arrow1'+CAT,333,'http://goo.gl/myds8d')
        addDir3('ARROW SEASON 2',BASE3+'arrow2'+CAT,333,'http://goo.gl/myds8d')
        addDir3('FEAR THE WALKING DEAD SEASON 1',BASE3+'fear'+CAT,333,'http://goo.gl/ggsJ8F')

def MOVVOD():
        addDir3('Movies',BASE4+'mov'+CAT,333,'http://goo.gl/ggsJ8F')

def TVVOD():
        addDir3('BLIND SPOT SEASON 1',BASE5+'blindspot1'+CAT,333,'http://goo.gl/9qnWZO')
        addDir3('SUPERGIRL SEASON 1',BASE5+'supergirl1'+CAT,333,'http://goo.gl/YALFP4')
        addDir3('THE LAST KINGDOM SEASON 1',BASE5+'thelastkingdom1'+CAT,333,'http://goo.gl/I6DKnX')
        addDir3('QUANTICO SEASON 1',BASE5+'Quantico1'+CAT,333,'http://goo.gl/yejlcN')

def COMVOD():
        addDir3('FAMILY GUY SEASON 1',BASE6+'fam1'+CAT,333,'http://goo.gl/sJI0Pu')
        addDir3('FAMILY GUY SEASON 2',BASE6+'fam2'+CAT,333,'http://goo.gl/sJI0Pu')
...
def Live_VOD(url):
        ...
        for url,iconimage,name in match:
                addDir4('%s'%(name).replace('GenieTv','[COLOR green]GenieTV[/COLOR]').replace('.',' ').replace('mp4','').replace('mkv','').replace('_',' '),'%s'%(url),222,'%s'%(iconimage))
def RESOLVE(url): 
...
BASE4 = base64.decodestring('aHR0cDovL2FyY2hpdGVjdHMueDEwaG9zdC5jb20vdm9kL21vdi8=')
BASE5 = base64.decodestring('aHR0cDovL2FyY2hpdGVjdHMueDEwaG9zdC5jb20vdm9kL3R2Lw==')
BASE6 = base64.decodestring('aHR0cDovL2FyY2hpdGVjdHMueDEwaG9zdC5jb20vdm9kL2NvbS8=')
BASE7 = base64.decodestring('aHR0cDovL2FyY2hpdGVjdHMueDEwaG9zdC5jb20vdm9kL2FwcnlsLw==')
